...
const int switchAddress = 1; // decoder address of this turnout
const int servoFullCW = 70; // Thrown position if servoRev = 0
const int servoFullCCW = 110;  // Closed position if servoRev = 0
int servoRev = 0; // normal = 0, reversed = 1
int revPoints = 0; // reverses the polarity to the points, normal = 0, rev = 1
// ***
...
int lastStatus;
byte epReadChar;
Servo myservo1;// Declare myservo1 as a servo
